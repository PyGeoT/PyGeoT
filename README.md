...
- The user must modify manually the measured Mg concentration in the line 129 of the script (PyGeoT_Part3) to graph the line in the plot and to compute the K-Mg geothermometer. 
